...
def generate_experiment_paths(output_dir, bulkName, refName):
    ...
    report_path = os.path.join(optim_dir, f"hyperopt_report_constraint.png")
    return output_dir, optim_dir, data_dir, config_path, best_json_path, trials_json_path, report_path
